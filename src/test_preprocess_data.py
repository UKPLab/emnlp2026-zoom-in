...
prepare_data(dataset_names=["pixel_reasoner_infovqa"],
             data_folders=["/pfss/mlde/workspaces/mlde_wsp_KIServiceCenter/helm/datasets/pixel_reasoner/eval/Infographics_VQA/test.jsonl"],
             image_folders=["/pfss/mlde/workspaces/mlde_wsp_KIServiceCenter/helm/datasets/pixel_reasoner/eval/Infographics_VQA"],
