...
RUN_ARGS=(
    ...
    --reward_func_weights 1 0.05
    --mutual_information_clip_value 2.0
    --mutual_information_len_exponent 1.0
    #--mutual_information_len_scaling 1.0
    --ignored_prefix_len 0
    --mi_full_forward_model self
    --mi_masked_vision_forward_model self
    --eps_tool_use_rate_threshold 0.25
    --eps_exploration_threshold 100
