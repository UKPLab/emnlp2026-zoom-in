...
export working_dir="/pfss/mlde/workspaces/mlde_wsp_UKP_Multimodal/helm/focusreason/src/pixel_reasoner/Pixel-Reasoner-main/curiosity_driven_rl"
...
export testdata="/pfss/mlde/workspaces/mlde_wsp_UKP_Multimodal/helm/datasets/focusreason/pixel_reasoner/data/${benchmark}.parquet"
export num_vllm=1
export num_gpus=8
export tp=1
